...
from Engine.Content import Ticker
...
class ProcessTickers:
    ...
    def start(self, strict=True):
        ...
        for hookup in self.original_hookups:
            ...
            if self.strict:
                potential_tickers = FAIR.Ticker.find_tickers_strict_v2(content=content)
            else:
                potential_tickers = FAIR.Ticker.find_tickers_light_v2(content=content)
